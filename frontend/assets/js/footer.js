/**
 * peruzi - Common Footer Component
    ...
    const footerHTML = isAuthPage ? `
        <footer class="auth-footer-section">
            <div class="footer-content">
                ...
                <p class="copyright">&copy; ${currentYear} peruzi. All rights reserved.</p>
            </div>
        </footer>
    ` : `
        <footer class="footer">
            <div class="footer-container">
                <div class="footer-brand">
                    <div class="logo">
                        <a href="index.html">
                            ...
                            <span class="logo-text">peruzi</span>
                        </a>
                    </div>
                ...
                <div class="footer-bottom">
                    <p>&copy; ${currentYear} peruzi. All rights reserved.</p>
