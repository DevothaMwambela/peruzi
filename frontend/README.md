...
A modern, responsive streaming platform frontend built with vanilla JavaScript, HTML5, and CSS3. This frontend integrates with the peruzi PHP backend API to provide a Netflix-like streaming experience.
...
- peruzi backend API running

### Installation

1. **Start the backend server**
   ```bash
   cd /opt/lampp/htdocs/peruzi
...
2. **Open the frontend**
   ...
   ```
   http://localhost/peruzi/frontend/index.html
   ```
...
## License
This project is part of the peruzi streaming platform.
