 ...
 * Run this file directly in your browser: http://localhost/peruzi/sql/seed.php
 */
...
echo "<!DOCTYPE html><html><head><title>Database Seeder - peruzi</title>";
echo "<style>
...
echo "<h1>🎬 peruzi Database Seeder</h1>";
